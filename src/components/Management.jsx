...
function Management({ staff, setStaff, users, setUsers, currentUser, isAdmin, departments, setDepartments }) {
  ...
  const addStaffMember = (e) => {
    ...
    if (nameExists) {
      alertError('⚠️ Attenzione: Esiste già un utente con questo nome.\nScegli un nome diverso per procedere con la registrazione.')
      return
    }
  ...
  const deleteStaffMember = (id) => {
    confirmDelete(
      'Sei sicuro di voler rimuovere questo membro del personale?',
      () => {
