...
// Categorie per i punti di conservazione (sincronizzate con PuntidiConservazione.jsx)
                      ...
                      >
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-green-600 mt-1">
                              {product.allergens && product.allergens.length > 0 
                                ? `Allergeni: ${product.allergens.map(a => ALLERGENS.find(al => al.id === a)?.name).join(', ')}`
                                : 'Nessun allergene'
                              }
                            </div>
                          </div>
